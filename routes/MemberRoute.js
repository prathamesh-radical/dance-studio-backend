...
import {
    AddMembership, AddStudent, RenewMembership, UpdateDetails, UpdateStudioName, UpdateUserCountry, UpdateUserEmail, UpdateUserName, UpdateUserNumber, UpdateUserPassword
...
MemberRoute.post("/addStudent", authenticateToken, AddStudent);
